...
namespace View
{
    ...
    public class Animator
    {
        ...
        //Constructor
        public Animator(string a_textureName, Vector2 a_origin, float a_rotation, float a_scale, float a_depth, int a_frameX, int a_frameY, int a_framesPerSec)
        {
        ...
        //Method for horizontal animations
        ...
        //Method for vertical animations
        ...
        //Method for non-animated frames
        public void StaticTexture(float a_elapsed, int a_frameX, int a_frameY)
        {
            m_frameY = a_frameY;
            m_frameX = a_frameX;
        }
        ...
        //Draw methods
        public void DrawFrame(SpriteBatch a_batch, Vector2 a_screenPos, int a_frameY, Color a_color)
        {
            DrawFrame(a_batch, m_frameX, a_frameY, a_screenPos, a_color);
        }
